...
$dbase = 'modx';
$table_prefix = 'modx_';
$database_dsn = 'mysql:host=mysql:3306;dbname=modx;charset=utf8';
$config_options = array (
);
$driver_options = array (
);

$lastInstallTime = 1655805076;

$site_id = 'modx62b1949416f015.71286638';
$site_sessionname = 'SN62b19447ee336';
$https_port = '443';
$uuid = 'c3947325-5e03-44a7-82c3-3ab582828e41';
...
if (!defined('MODX_HTTP_HOST')) {
    if(defined('PHP_SAPI') && (PHP_SAPI == "cli" || PHP_SAPI == "embed")) {
        ...
        $http_host= array_key_exists('HTTP_HOST', $_SERVER) ? htmlspecialchars($_SERVER['HTTP_HOST'], ENT_QUOTES) : 'localhost:8000';
